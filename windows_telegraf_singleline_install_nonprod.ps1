...
$telegrafnonprodconfigUrl = "https://raw.githubusercontent.com/mayankkapoor/statuscheck/staging/windows_telegraf_nonprod.conf"
$telegrafprodconfigUrl = "https://raw.githubusercontent.com/mayankkapoor/statuscheck/staging/windows_telegraf_prod.conf"
...
Invoke-WebRequest -Uri $telegrafnonprodconfigUrl -OutFile $telegrafconfpath
